    ...
    <form action="{{url('/article')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="md-form">
                    <i class="fa fa-envelope prefix"></i>
                    <input type="text" id="form833" class="form-control validate" name="chapo" required>
                    <label for="form833" data-error="wrong" data-success="right">Chapo</label>
                </div>
            </div>
        </div>
        <!--/.First row-->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="md-form">
                    <textarea type="text" id="form76" name="corps" class="md-textarea" required></textarea>
